...
loc_name="C:\Users\viu837\OneDrive - The University of Texas-Rio Grande Valley\Documents\MATLAB\HIV\IFIT3";
...
Class1Correct=sum(YPredtest(Touttest==categorical(1))==Touttest(Touttest==categorical(1)))
Class1Total=sum(YPredtest==categorical(1))
TestaccuracyClass1=Class1Correct/Class1Total*100

Class2Correct=sum(YPredtest(Touttest==categorical(2))==Touttest(Touttest==categorical(2)))
Class2Total=sum(YPredtest==categorical(2))
TestaccuracyClass2=Class2Correct/Class2Total*100

Class3Correct=sum(YPredtest(Touttest==categorical(3))==Touttest(Touttest==categorical(3)))
